                    ...
                    <div className="single-results-item col-10 offset-1  card rounded  my-3">
                        <div className="row">
                            ...
                            <div className="col-md-7 col-sm-12 col-12 single-results-written-content">
                                ...
                                <div>
                                    <h5 onClick={this.handleManufacturerNameClick.bind(this)} className="manufacturer single-results-links"><a target="_blank" href={manufacturer_site}>{manufacturer_site}</a></h5>
                                </div>
